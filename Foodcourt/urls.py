...
urlpatterns = [
    ...
    path('admin-dashboard/coupons/', views.admin_dashboard_view, {'section': 'coupons'}, name='admin_coupons'),
    path('admin-dashboard/coupons/api/', views.admin_coupon_api, name='admin_coupon_api'),
    path('api/coupons/validate/', views.coupon_validate_api, name='coupon_validate_api'),
    ...
    path('admin-dashboard/users/add/', views.admin_user_add_view, name='admin_user_add'),
    path('admin-dashboard/users/<int:pk>/edit/', views.admin_user_edit_view, name='admin_user_edit'),
    ...
    path('admin-dashboard/orders/<str:order_id>/detail-api/', views.admin_order_detail_api, name='admin_order_detail_api'),
